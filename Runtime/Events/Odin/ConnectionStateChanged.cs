...
{
    /// <summary>
    /// This class provides the base functionality for UnityEvents based on <see cref="OdinNative.Wrapper.Room.RoomConnectionStateChangedEventHandler"/>.
    ...
    /// </summary>
    [Serializable]
    public class RoomStateChangedProxy : UnityEvent<object, RoomStateChangedEventArgs>
    {
    }
}
