...
{
    /// <summary>
    /// This class provides the base functionality for UnityEvents based <see cref="OdinNative.Wrapper.Room.RoomMediaAddedEventHandler"/>.
    ...
    /// </summary>
    [Serializable]
    public class DatagramProxy : UnityEvent<object, DatagramEventArgs>
    {
    }
}