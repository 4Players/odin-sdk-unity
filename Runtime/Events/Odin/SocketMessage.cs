...
{
    /// <summary>
    /// This class provides the base functionality for UnityEvents based on <see cref="OdinNative.Wrapper.Socket.SocketMessageEventHandler"/>.
    ...
    /// </summary>
    [Serializable]
    public class SocketMessageReceivedProxy : UnityEvent<object, SocketMessageEventArgs>
    {
    }
}
