...
namespace OdinNative.Core.Imports
{
    ...
    public partial class NativeCryptoMethods : NativeMethods<OdinCryptoHandle>
    {
        ...
        internal delegate IntPtr OdinCryptoCreateDelegate([MarshalAs(UnmanagedType.LPUTF8Str)] string version);
        ...
        /// </remarks>
        [UnmanagedFunctionPointer(Native.OdinCallingConvention)]
        internal delegate OdinCryptoPeerStatus OdinCryptoGetPeerStatusDelegate(IntPtr cipher, uint peer_id);
