...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public static readonly IReadOnlyCollection<PlatformBinaryLocations> BinaryLocations = new List<PlatformBinaryLocations>
        {
            ...
            new PlatformBinaryLocations()
            {
                ...
                Paths = new string[] {
#if UNITY_64
                    string.Format("{0}", UnityEngine.Application.dataPath), // Data
                    string.Format("{0}/../{1}", UnityEngine.Application.dataPath, "Frameworks"), // Frameworks
                    string.Format("{0}/../{1}", UnityEngine.Application.dataPath, "PlugIns"), // PlugIns
                    string.Format("{0}/../{1}", UnityEngine.Application.dataPath, "SharedSupport"), // SharedSupport
#endif
                },
                Is64Bit = true,
            },
