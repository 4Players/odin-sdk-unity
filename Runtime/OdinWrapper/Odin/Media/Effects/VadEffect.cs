...
namespace OdinNative.Wrapper.Media
{
    ...
    /// </summary>
    public class VadEffect : PipelineEffect
    {
        /// <summary>
...
#pragma warning disable CS0618 // Type or member is obsolete
            OdinLog.Throw(new OdinWrapperException($"must be of type {typeof(VadEffect)}", new NotSupportedException($"{typeof(ApmEffect)} call of type {typeof(VadEffect)}")));
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// <summary>
        /// Insert a vad effect in the specified pipeline
        /// </summary>
        /// <param name="pipeline">where to create a vad effect</param>
        /// <param name="vad">created <see cref="VadEffect"/> instance or null</param>
        /// <returns>true on success or false</returns>
        ...
        /// <summary>
        /// Insert a vad effect in the specified pipeline and sets the vad config
        /// </summary>
        /// <param name="pipeline">where to create a vad effect</param>
