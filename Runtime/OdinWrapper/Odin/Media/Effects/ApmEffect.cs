...
{
    /// <summary>
    /// Audio Processing Module (APM) effect for <see cref="MediaPipeline"/>
    /// </summary>
    public class ApmEffect : PipelineEffect
    {
        /// <summary>
        ...
        /// </summary>
        public OdinNoiseSuppressionLevel NoiseSuppressionLevel { get => Config.noise_suppression; set => Config.noise_suppression = value; }
        /// <summary>
        /// Indicates whether the ApmConfig setting is enabled
        /// </summary>
        ...
        /// </summary>
        public OdinGainControllerVersion GainControllerVersion { get => Config.gain_controller_version; set => Config.gain_controller_version = value; }
        ...
        /// </summary>
        /// <param name="pipeline">currently unused</param>
...
#pragma warning disable CS0618 // Type or member is obsolete
            OdinLog.Throw(new OdinWrapperException($"must be of type {typeof(ApmEffect)}", new NotSupportedException($"{typeof(VadEffect)} call of type {typeof(ApmEffect)}")));
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// </summary>
        /// <param name="pipeline">where to create an APM effect</param>
